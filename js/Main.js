...
function createInstructions1() {
	...
	text = document.createElement( 'div' );
	text.onSelectStart = null;
	text.innerHTML = '<span style="color:' + theme[0] + ';font-size:38px;font-family: "楷体";"><a style="text-decoration:none;color:' + theme[1] + ';" href="forum.html">进入主空间</a></span>';
	text.style.color = theme[1];
	text.style.position = 'absolute';
	text.style.left = '0px';
	text.style.top = '0px';
